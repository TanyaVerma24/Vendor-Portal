...
export default function Dashboard() {
  ...
  const { vendor, loading, setVendor } = useVendors();

  const toast = useRef(null);

  //get data of vendor
  async function getVendorsDetails() {
    const typeList = vendor.map((v) => v.category);
    ...
    const riskList = vendor.map((v) => v.riskLevel);
